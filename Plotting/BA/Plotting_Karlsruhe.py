...
datei1 = r'C:\Users\fabio\PycharmProjects\Bachelorarbeit_Git\Outputdateien\Karlsruhe\RDK_Shuttle_ohneDWPT.xlsx'
datei2 = r'C:\Users\fabio\PycharmProjects\Bachelorarbeit_Git\Outputdateien\Karlsruhe\RDK_Shuttle_mitDWPT.xlsx'
...
plt.plot_date(x1, y1, '--', label='stationäre Ladung an der Bushaltestelle', zorder=10)
plt.plot_date(x2, y2, '-', label='zusätzliche DWPT-Strecke (\SI{600}{\metre})', zorder=5)
...
fig.savefig(r'C:\Users\fabio\Studium\Bachelorarbeit\BA Latex\Latex_Bachelorarbeit\Bilder\SoC_Karlsruhe.pgf')