...
datei2 = r'C:\Users\fabio\PycharmProjects\Bachelorarbeit_Git\Outputdateien\Balingen\Linie 24\Kein Halt auf Tübinger Str\Linie24_keinHaltaufTuebingerStr.xlsx'
...
for j in range(0,(len(y2)-index)):
    y2[index + j] = 0

plt.plot_date(x1, y1, '-', label='3 Haltestellen in DWPT-Zone (Basis)')
plt.plot_date(x2, y2, '-', label='1 Haltestelle in DWPT-Zone (B)')
...
fig.savefig(r'C:\Users\fabio\Studium\Bachelorarbeit\BA Latex\Latex_Bachelorarbeit\Bilder\SoC_Entfall2Halte.pgf')
