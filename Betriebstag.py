...
def energieverbrauch():
    global soc, kumulierter_energieverbrauch, uhrzeit, t, zurueckgelegte_distanz, v_ist, v_soll, steigung, \
        beschleunigung, leistung_batterie, liste, ladeleistung, aussentemperatur, leistung_em, leistung_nv
...
#TODO: Leistung für Antrieb, Leistung Nebenverbraucher (Klimatisierung) ausgeben
def daten_sichern():
...
def fahren():
    global soc, kumulierter_energieverbrauch, uhrzeit, t, zurueckgelegte_distanz, v_ist, v_soll, steigung, \
        beschleunigung, leistung_batterie, liste, ladeleistung, aussentemperatur, energieverbrauch_im_intervall, status
...
def stehen(sekunden):
    global soc, kumulierter_energieverbrauch, uhrzeit, t, zurueckgelegte_distanz, v_ist, v_soll, steigung, \
        beschleunigung, leistung_batterie, liste, ladeleistung, aussentemperatur, energieverbrauch_im_intervall, status, leistung_nv, leistung_em
