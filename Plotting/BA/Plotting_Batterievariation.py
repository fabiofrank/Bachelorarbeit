...
######################C:\Users\fabio\PycharmProjects\Bachelorarbeit_Git\Outputdateien\Balingen\Linie 24\Basisszenario\Basisszenario_Linie24_inklMittagspause.xlsx##########################################################################################################
fig, ax = plt.subplots(1, 1)

datei1 = r'C:\Users\fabio\PycharmProjects\Bachelorarbeit_Git\Outputdateien\Balingen\Linie 24\Batteriekapazität\Linie24_groessereBatterie.xlsx'
...
datei3 = r'C:\Users\fabio\PycharmProjects\Bachelorarbeit_Git\Outputdateien\Balingen\Linie 24\Batteriekapazität\Linie24_kleinereBatterie.xlsx'
...
plt.plot_date(x1, y1, '-', label='\SI{224}{\kWh}')
plt.plot_date(x2, y2, '-', label='\SI{174}{\kWh} (Basis)')
plt.plot_date(x2, y3, '-', label='\SI{124}{\kWh} (E)')
...
fig.savefig(r'C:\Users\fabio\Studium\Bachelorarbeit\BA Latex\Latex_Bachelorarbeit\Bilder\SoC_Batterievariation.pgf')
